...
<body>
	<h1 style="text-align: center">Show Claims And Calculation Table</h1>
	...
	<div class="row">
		...
		<div class="row">
			...
			<div class="col-sm-7">
				<div class="">
					<input type="text" class="form-control" id="policyno" value="${policyholdervat+policyholder.getPolicyamount()+policyholderrisk} taka">
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-sm-7">
				<div class="">
					<input type="text" class="form-control" id="policyno" value="${premiumvalue} taka">
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-sm-7">
				<div class="">
					<input type="text" class="form-control" id="policyno" value="${policyholder.getMaturityyear()-1} Years">
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-sm-7">
				<div class="">
					<input type="text" class="form-control" id="policyno" value="${policyholder.getPolicyamount()-premiumvalue} taka">
				</div>
			</div>
		</div>
	</div>
