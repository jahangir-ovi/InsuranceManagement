	...
	<div class="container-fluid">
		<div class="row">
			<nav id="sidebarMenu"
				...
				<div class="position-sticky pt-3">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="/propsal">
			...
			<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
				<h1 style="text-align: center">Insurance Dashboard</h1> <hr>
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								...
								<form action="/endowment" onclick="submit">
								<div class="card-header">ENDOWMENT INSURANCE</div>
								<div class="card-body">			
									<h2 class="card-text">Total Policy = ${ei}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
						...
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								style="max-width: 18rem;">
								<form action="/anticipated" onclick="submit">
								<div class="card-header">ANTICIPATED ENDOWMENT INSURANCE</div>
								<div class="card-body">
									<h2 class="card-text">Total Policy = ${aei}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
						...
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								style="max-width: 18rem;">
								<form action="/childprotection" onclick="submit">
								<div class="card-header">CHILD PROTECTION INSURANCE</div>
								<div class="card-body">
									<h2 class="card-text">Total Policy = ${cpi}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								style="max-width: 18rem;">
								<form action="/pension" onclick="submit">
								<div class="card-header">PENSION INSURANCE</div>
								<div class="card-body">
									<h2 class="card-text">Total Policy = ${pi}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
						...
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								style="max-width: 18rem;">
								<form action="/wholelife" onclick="submit">
								<div class="card-header">WHOLE LIFE INSURANCE</div>
								<div class="card-body">
									<h2 class="card-text">Total Policy = ${wli}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
						...
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								style="max-width: 18rem;">
								<form action="/singlepayment" onclick="submit">
								<div class="card-header">SINGLE PAYMENT INSURANCE</div>
								<div class="card-body">
									<h2 class="card-text">Total Policy = ${spi}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
						...
						<div class="col-sm-4">
							<div class="card text-white bg-secondary mb-3"
								style="max-width: 18rem;">
								<form action="/doublepayment" onclick="submit">
								<div class="card-header">DOUBLE PROTECTION ENDOWMENT INSURANCE</div>
								<div class="card-body">
									<h2 class="card-text">Total Policy = ${dpi}</h2>
									<button class="button" style="vertical-align:middle"><span>Features & Eligibility</span></button>
