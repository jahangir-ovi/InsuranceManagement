	...
	<header
		...
		<div class="dropdown">
			...
			<ul class="dropdown-menu dropdown-menu-dark text-small shadow"
				...
				<li><a class="dropdown-item" href="#"><span><i class="bi bi-app-indicator"></i> </span> Profile</a></li>
				<li><a class="dropdown-item" href="#"><span><i class="bi bi-box-arrow-left"></i> </span> Sign out</a></li>
			</ul>
		</div>
			...
			<nav id="sidebarMenu"
				...
				<div class="position-sticky pt-3">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="/addform"> <span
								data-feather="file"><i
